...
//
//                                        Capsule()
//                                            .frame(width: CGFloat(0.52) * 180, height: 8)
//                                            .foregroundStyle(
//                                                LinearGradient(
//                                                    colors: [
//                                                        Color(red: 153/255, green: 0/255, blue: 0/255),
...
//                        // Skill Cards
//                        VStack(spacing: 15) {
//                            SkillCardView(symbolName: "brain", skillName: "Resilience", level: 3, progress: 0.4, trend: 2, destination: AnyView(ResilienceView()))
//                            SkillCardView(symbolName: "fork.knife", skillName: "Fuel", level: 2, progress: 0.6, trend: 1, destination: AnyView(FuelView()))
//                            SkillCardView(symbolName: "figure.run", skillName: "Fitness", level: 4, progress: 0.5, trend: -4, destination: AnyView(FitnessView()))
//                            SkillCardView(symbolName: "book.fill", skillName: "Wisdom", level: 1, progress: 0.2, trend: 8, destination: AnyView(WisdomView()))
//                            SkillCardView(symbolName: "infinity", skillName: "Discipline", level: 3, progress: 0.3, trend: 2, destination: AnyView(DisciplineView()))
//                            SkillCardView(symbolName: "person.2.fill", skillName: "Network", level: 1, progress: 0.99, trend: 3, destination: AnyView(NetworkView()))
//                        }
//
//                        Spacer(minLength: 40)
//                    }
